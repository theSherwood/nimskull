/* Generated by the Nim Compiler v0.1.0-dev.20511 */
var framePtr = null;
var excHandler = 0;
...
function chckRange(i_33557193, a_33557194, b_33557195) {
      var Temporary1;

  var result_33557196 = 0;

  BeforeRet: do {
      if (!(a_33557194 <= i_33557193)) Temporary1 = false; else {        Temporary1 = (i_33557193 <= b_33557195);      }    if (Temporary1) {
    result_33557196 = i_33557193;
    break BeforeRet;
    }
    else {
    raiseRangeError();
...
function nimCopy(dest_33557144, src_33557145, ti_33557146) {
  var result_33557155 = null;
    ...
    case 4:
    case 16:
            if(ArrayBuffer.isView(src_33557145)) { 
        if(dest_33557144 === null || dest_33557144 === undefined || dest_33557144.length != src_33557145.length) {
          dest_33557144 = new src_33557145.constructor(src_33557145);
        } else {
          dest_33557144.set(src_33557145, 0);
        }
        result_33557155 = dest_33557144;
      } else {
...
function chckIndx(i_33557188, a_33557189, b_33557190) {
  ...
  BeforeRet: do {
      if (!(a_33557189 <= i_33557188)) Temporary1 = false; else {        Temporary1 = (i_33557188 <= b_33557190);      }    if (Temporary1) {
...
function addChar(x_33557262, c_33557263) {
    x_33557262.push(c_33557263);
...
function raiseIndexError(i_33556753, a_33556754, b_33556755) {
    ...
    raiseException({name: "IndexDefect", message: nimCopy(null, Temporary1, NTI33554439), parent: null, m_type: NTI33555124, trace: [], up: null}, "IndexDefect");
...
function HEX3Aanonymous_469762775(a_469762780, b_469762781) {
  ...
  var result_469762720 = null;
    ...
    contents_469762711[0] = nimCopy(null, [], NTI469762605);
    Label1: do {
