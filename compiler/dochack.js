/* Generated by the Nim Compiler v0.1.0-dev.20301 */
var framePtr = null;
var excHandler = 0;
...
function raiseException(e_33556652, ename_33556653) {
    if ((e_33556652.name == null)) {
    e_33556652.name = ename_33556653;
    }
    
    if ((excHandler == 0)) {
    unhandledException(e_33556652);
    }
...
function chckRange(i_33557192, a_33557193, b_33557194) {
      var Temporary1;

  var result_33557195 = 0;

  BeforeRet: do {
      if (!(a_33557193 <= i_33557192)) Temporary1 = false; else {        Temporary1 = (i_33557192 <= b_33557194);      }    if (Temporary1) {
    result_33557195 = i_33557192;
    break BeforeRet;
    }
    else {
    raiseRangeError();
...
function nimCopy(dest_33557143, src_33557144, ti_33557145) {
  var result_33557154 = null;

    switch (ti_33557145.kind) {
    case 21:
    case 22:
    case 23:
    case 5:
      if (!(isFatPointer_33557134(ti_33557145))) {
      result_33557154 = src_33557144;
      }
      else {
        result_33557154 = [src_33557144[0], src_33557144[1]];
      }
      
      break;
    case 19:
            if (dest_33557143 === null || dest_33557143 === undefined) {
        dest_33557143 = {};
      }
      else {
        for (var key in dest_33557143) { delete dest_33557143[key]; }
      }
      for (var key in src_33557144) { dest_33557143[key] = src_33557144[key]; }
      result_33557154 = dest_33557143;
    
      break;
    case 18:
    case 17:
      if (!((ti_33557145.base == null))) {
      result_33557154 = nimCopy(dest_33557143, src_33557144, ti_33557145.base);
      }
      else {
      if ((ti_33557145.kind == 17)) {
      result_33557154 = (dest_33557143 === null || dest_33557143 === undefined) ? {m_type: ti_33557145} : dest_33557143;
      }
      else {
        result_33557154 = (dest_33557143 === null || dest_33557143 === undefined) ? {} : dest_33557143;
      }
      }
      nimCopyAux(result_33557154, src_33557144, ti_33557145.node);
      break;
    case 4:
    case 16:
            if(ArrayBuffer.isView(src_33557144)) { 
        if(dest_33557143 === null || dest_33557143 === undefined || dest_33557143.length != src_33557144.length) {
          dest_33557143 = new src_33557144.constructor(src_33557144);
        } else {
          dest_33557143.set(src_33557144, 0);
        }
        result_33557154 = dest_33557143;
      } else {
        if (src_33557144 === null) {
          result_33557154 = null;
        }
        else {
          if (dest_33557143 === null || dest_33557143 === undefined || dest_33557143.length != src_33557144.length) {
            dest_33557143 = new Array(src_33557144.length);
          }
          result_33557154 = dest_33557143;
          for (var i = 0; i < src_33557144.length; ++i) {
            result_33557154[i] = nimCopy(result_33557154[i], src_33557144[i], ti_33557145.base);
          }
        }
      }
    ...
    case 28:
            if (src_33557144 !== null) {
        result_33557154 = src_33557144.slice(0);
      }
  ...
  return result_33557154;

}

function chckIndx(i_33557187, a_33557188, b_33557189) {
      var Temporary1;

  var result_33557190 = 0;

  BeforeRet: do {
      if (!(a_33557188 <= i_33557187)) Temporary1 = false; else {        Temporary1 = (i_33557187 <= b_33557189);      }    if (Temporary1) {
    result_33557190 = i_33557187;
    break BeforeRet;
    }
    else {
    raiseIndexError(i_33557187, a_33557188, b_33557189);
    }
    
  } while (false);

  return result_33557190;
...
function nimMax(a_33557001, b_33557002) {
    var Temporary1;

  var result_33557003 = 0;

  BeforeRet: do {
    if ((b_33557002 <= a_33557001)) {
...
function nimMin(a_33556997, b_33556998) {
    var Temporary1;

  var result_33556999 = 0;

  BeforeRet: do {
    if ((a_33556997 <= b_33556998)) {
    Temporary1 = a_33556997;
    }
    else {
    Temporary1 = b_33556998;
    }
    
    result_33556999 = Temporary1;
    break BeforeRet;
  } while (false);
...
function add_33556404(x_33556405, x_33556405_Idx, y_33556406) {
          if (x_33556405[x_33556405_Idx] === null) { x_33556405[x_33556405_Idx] = []; }
      var off = x_33556405[x_33556405_Idx].length;
      x_33556405[x_33556405_Idx].length += y_33556406.length;
      for (var i = 0; i < y_33556406.length; ++i) {
        x_33556405[x_33556405_Idx][off+i] = y_33556406.charCodeAt(i);
      }
...
function unhandledException(e_33556648) {
    var buf_33556649 = [[]];
    if (!(((e_33556648.message).length == 0))) {
    buf_33556649[0].push.apply(buf_33556649[0], makeNimstrLit("Error: unhandled exception: "));;
    buf_33556649[0].push.apply(buf_33556649[0], e_33556648.message);;
    }
    else {
    buf_33556649[0].push.apply(buf_33556649[0], makeNimstrLit("Error: unhandled exception"));;
    }
    
    buf_33556649[0].push.apply(buf_33556649[0], makeNimstrLit(" ["));;
    add_33556404(buf_33556649, 0, e_33556648.name);
    buf_33556649[0].push.apply(buf_33556649[0], makeNimstrLit("]\x0A"));;
    var cbuf_33556650 = toJSStr(buf_33556649[0]);
    framePtr = null;
      if (typeof(Error) !== "undefined") {
    throw new Error(cbuf_33556650);
  }
  else {
    throw cbuf_33556650;
  }
...
function isFatPointer_33557134(ti_33557135) {
  var result_33557136 = false;

  BeforeRet: do {
    result_33557136 = !((ConstSet1[ti_33557135.base.kind] != undefined));
    break BeforeRet;
  } while (false);

  return result_33557136;

}

function nimCopyAux(dest_33557147, src_33557148, n_33557149) {
    switch (n_33557149.kind) {
    case 0:
      break;
    case 1:
            dest_33557147[n_33557149.offset] = nimCopy(dest_33557147[n_33557149.offset], src_33557148[n_33557149.offset], n_33557149.typ);
    
      break;
    case 2:
          for (var i = 0; i < n_33557149.sons.length; i++) {
      nimCopyAux(dest_33557147, src_33557148, n_33557149.sons[i]);
    }
    ...
    case 3:
            dest_33557147[n_33557149.offset] = nimCopy(dest_33557147[n_33557149.offset], src_33557148[n_33557149.offset], n_33557149.typ);
      for (var i = 0; i < n_33557149.sons.length; ++i) {
        nimCopyAux(dest_33557147, src_33557148, n_33557149.sons[i][1]);
      }
...
function raiseIndexError(i_33556751, a_33556752, b_33556753) {
    ...
    Temporary1 = (makeNimstrLit("index ") || []).concat(HEX24_318767107(i_33556751) || [],makeNimstrLit(" not in ") || [],HEX24_318767107(a_33556752) || [],makeNimstrLit(" .. ") || [],HEX24_318767107(b_33556753) || []);
    }
