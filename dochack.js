/* Generated by the Nim Compiler v0.1.0-dev.21110 */
var framePtr = null;
var excHandler = 0;
...
function toJSStr(s_1) {
  ...
  var result_0 = null;
    ...
    var res_2 = newSeq_50334065((s_1).length);
    var i_3 = 0;
    var j_4 = 0;
    Label1: {
      while (true) {
        ...
        Label2: {
          ...
          var helper_6 = newSeq_50334065(0);
          Label3: {
            while (true) {
...
function raiseIndexError(i_1, a_2, b_3) {
    ...
    Label1: {
      ...
      _4 = nimCopy(null, formatErrorIndexBoundStr_50333699(HEX24_335544323(i_1), HEX24_335544323(a_2), HEX24_335544323(b_3)), NTI50331655);
    }
    raiseException({name: "IndexDefect", message: nimCopy(null, _4, NTI50331655), parent: null, m_type: NTI50332361, trace: [], up: null}, "IndexDefect");
...
function raiseOverflow() {
    raiseException({name: "OverflowDefect", message: makeNimstrLit("over- or underflow"), parent: null, m_type: NTI50332355, trace: [], up: null}, "OverflowDefect");
...
function raiseRangeError() {
    raiseException({name: "RangeDefect", message: makeNimstrLit("value out of range"), parent: null, m_type: NTI50332363, trace: [], up: null}, "RangeDefect");
...
function groupBy(value_1) {
    ...
    if ((alternative_33555017[0] == null)) {
    var tt_3 = {heading: null, kids: [], sortId: 0, doSort: false};
    toToc_33554755(toc_2, tt_3);
    ...
    var ntoc_6 = buildToc_33554940(tt_3, types_4[0], procs_5[0]);
    var x_7 = toHtml_33554609(ntoc_6, true);
    alternative_33555017[0] = tree_33554439(makeNimstrLit("DIV"), [x_7]);
    }
    Label1: {
      if ((value_1 == "type")) {
    ...
    togglevis_33555018(document.getElementById("toc-list"));

  
}

function search() {
    if (!((timer_33555192[0] == null))) {
    clearTimeout(timer_33555192[0]);
    }
    timer_33555192[0] = setTimeout(makeClosure(wrapper_33555203, null), 400);
    ...
    Label1: {
        ...
        while (true) {
          ...
          Label3: {
            while (true) {
                ...
                if (_6) {
                _6 = isWhitespace_33554752(x_1.childNodes[nxt_5]);
                }
              if (!(_6)) {
              break Label3;
              }
          ...
          Label4: {
            ...
            Label5: {
              while (true) {
                ...
                var j_15 = i_14;
                toToc_33554755(it_11.childNodes[j_15], e_10);
                i_14 = addInt(i_14, 1);
              }
            }
            f_3.kids.push(e_10);;
            ...
            toToc_33554755(x_1.childNodes[i_4], f_3);
            i_4 = addInt(i_4, 1);
          }
        }
      }
      ...
      Label6: {
        while (true) {
          ...
          var i_20 = i_19;
          if (!(isWhitespace_33554752(x_1.childNodes[i_20]))) {
          idx_16.push(i_20);;
          }
          i_19 = addInt(i_19, 1);
        }
      ...
      Label7: {
        ...
        Label8: {
          while (true) {
            ...
            var j_27 = i_26;
            toToc_33554755(it_23.childNodes[j_27], e_22);
            i_26 = addInt(i_26, 1);
          }
        }
        ...
        Label9: {
          while (true) {
            ...
            var i_31 = i_30;
            toToc_33554755(x_1.childNodes[i_31], father_2);
            i_30 = addInt(i_30, 1);
          }
        }
      }
...
function buildToc_33554940(orig_1, types_2, procs_3) {
  var result_0 = null;
    ...
    var a_5 = nimCopy(null, types_2, NTI33554837);
    var i_6 = 0;
    var L_7 = (a_5).length;
    Label1: {
      while (true) {
        ...
        var a_10 = nimCopy(null, procs_3, NTI33554837);
        var i_11 = 0;
...
function wrapper_33555203() {
    ...
    Label1: {
      ...
      if ((oldtoc_33555191[0] == null)) {
      oldtoc_33555191[0] = document.getElementById("tocRoot");
      }
      var results_3 = dosearch_33555051(value_2);
...
function dosearch_33555051(value_1) {
  var result_0 = null;
    ...
    db_33555043[0] = nimCopy(null, stuff_2.getElementsByClassName("reference"), NTI520094140);
    contents_33555044[0] = nimCopy(null, [], NTI33554982);
    var a_3 = nimCopy(null, db_33555043[0], NTI33554964);
    var i_4 = 0;
    var L_5 = (a_3).length;
    Label1: {
      while (true) {
        ...
        contents_33555044[0].push(ahref_6.getAttribute("data-doc-search-tag"));;
        i_4 = addInt(i_4, 1);
        if (!(((a_3).length == L_5))) {
        failedAssertImpl_251658295(makeNimstrLit("iterators.nim(241, 11) `len(a) == L` the length of the seq changed while iterating over it"));
        }
    ...
    Label2: {
      while (true) {
        ...
        var i_12 = i_11;
        Label3: {
          var c_13 = contents_33555044[0][chckIndx(i_12, 0, (contents_33555044[0]).length - 1)];
          var _14 = false;
          _14 = (c_13 == "Examples");
          if (!(_14)) {
          ...
          if (matched_17) {
          matches_8[0].push({Field0: db_33555043[0][chckIndx(i_12, 0, (db_33555043[0]).length - 1)], Field1: score_16});;
          }
        }
        i_11 = addInt(i_11, 1);
      }
    }
    matches_8[0].sort(makeClosure(HEX3Aanonymous_33555108, null));
    var a_18 = 0;
    var b_19 = nimMin((matches_8[0]).length, 29);
    var i_20 = a_18;
    Label4: {
      while (true) {
        if (!((i_20 < b_19))) {
        ...
        var i_21 = i_20;
        matches_8[0][chckIndx(i_21, 0, (matches_8[0]).length - 1)].Field0.innerHTML = matches_8[0][chckIndx(i_21, 0, (matches_8[0]).length - 1)].Field0.getAttribute("data-doc-search-tag");
        escapeCString_33555047(matches_8[0][chckIndx(i_21, 0, (matches_8[0]).length - 1)].Field0, "innerHTML");
        add_33554483(ul_7, tree_33554439(makeNimstrLit("LI"), [matches_8[0][chckIndx(i_21, 0, (matches_8[0]).length - 1)].Field0]));
        i_20 = addInt(i_20, 1);
      }
    }
    Label5: {
  ...
  BeforeRet: {
    ...
    Label2: {
      while (true) {
        ...
        var i_6 = i_5;
        var y_7 = uncovered_33554886(x_1.kids[chckIndx(i_6, 0, (x_1.kids).length - 1)]);
        if (!((y_7 == null))) {
...
function sysFatal_251658273(message_2) {
    raiseException({message: nimCopy(null, message_2, NTI50331655), m_type: NTI50332357, parent: null, name: null, trace: [], up: null}, "AssertionDefect");
