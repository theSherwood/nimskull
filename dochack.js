/* Generated by the Nim Compiler v0.1.0-dev.20430 */
var framePtr = null;
var excHandler = 0;
...
function makeNimstrLit(c_33556806) {
      var result = [];
  for (var i = 0; i < c_33556806.length; ++i) {
    result[i] = c_33556806.charCodeAt(i);
  }
  return result;
...
function toJSStr(s_33556812) {
                    var Temporary5;
            var Temporary7;

  var result_33556813 = null;

    var res_33556847 = newSeq_33556830((s_33556812).length);
    var i_33556848 = 0;
    var j_33556849 = 0;
    Label1: do {
        Label2: while (true) {
        if (!(i_33556848 < (s_33556812).length)) break Label2;
          var c_33556850 = s_33556812[i_33556848];
          if ((c_33556850 < 128)) {
          res_33556847[j_33556849] = String.fromCharCode(c_33556850);
          i_33556848 += 1;
          }
          else {
            var helper_33556862 = newSeq_33556830(0);
            Label3: do {
                Label4: while (true) {
                if (!true) break Label4;
                  var code_33556863 = c_33556850.toString(16);
                  if ((((code_33556863) == null ? 0 : (code_33556863).length) == 1)) {
                  helper_33556862.push("%0");;
                  }
                  else {
                  helper_33556862.push("%");;
                  }
                  
                  helper_33556862.push(code_33556863);;
                  i_33556848 += 1;
                    if (((s_33556812).length <= i_33556848)) Temporary5 = true; else {                      Temporary5 = (s_33556812[i_33556848] < 128);                    }                  if (Temporary5) {
                  break Label3;
                  }
                  
                  c_33556850 = s_33556812[i_33556848];
                }
            } while (false);
++excHandler;
            Temporary7 = framePtr;
            try {
            res_33556847[j_33556849] = decodeURIComponent(helper_33556862.join(""));
--excHandler;
} catch (EXCEPTION) {
 ...
 --excHandler;
            framePtr = Temporary7;
            res_33556847[j_33556849] = helper_33556862.join("");
    ...
    if (res_33556847.length < j_33556849) { for (var i = res_33556847.length ; i < j_33556849 ; ++i) res_33556847.push(null); }
               else { res_33556847.length = j_33556849; };
    result_33556813 = res_33556847.join("");

  return result_33556813;

}

function raiseException(e_33556654, ename_33556655) {
    if ((e_33556654.name == null)) {
...
function addInt(a_33556945, b_33556946) {
...
function mnewString(len_33556898) {
        return new Array(len_33556898);
...
function subInt(a_33556949, b_33556950) {
...
function mulInt(a_33556953, b_33556954) {
        var result = a_33556953 * b_33556954;
    checkOverflowInt(result);
    return result;
...
function nimMax(a_33557003, b_33557004) {
    var Temporary1;

  var result_33557005 = 0;

  BeforeRet: do {
    if ((b_33557004 <= a_33557003)) {
    Temporary1 = a_33557003;
    }
    else {
    Temporary1 = b_33557004;
    }
    
    result_33557005 = Temporary1;
    break BeforeRet;
  } while (false);

  return result_33557005;

}

function nimMin(a_33556999, b_33557000) {
    var Temporary1;

  var result_33557001 = 0;

  BeforeRet: do {
    if ((a_33556999 <= b_33557000)) {
...
function newSeq_33556830(len_33556832) {
  var result_33556833 = [];

    result_33556833 = new Array(len_33556832); for (var i = 0 ; i < len_33556832 ; ++i) { result_33556833[i] = null; }
  return result_33556833;
...
function unhandledException(e_33556650) {
    ...
    add_33556406(buf_33556651, 0, e_33556650.name);
...
function raiseOverflow() {
    raiseException({name: "OverflowDefect", message: makeNimstrLit("over- or underflow"), parent: null, m_type: NTI33555122, trace: [], up: null}, "OverflowDefect");

  
}

function checkOverflowInt(a_33556943) {
        if (a_33556943 > 2147483647 || a_33556943 < -2147483648) raiseOverflow();
...
function raiseRangeError() {
    raiseException({name: "RangeDefect", message: makeNimstrLit("value out of range"), parent: null, m_type: NTI33555130, trace: [], up: null}, "RangeDefect");
...
function raiseIndexError(i_33556753, a_33556754, b_33556755) {
    var Temporary1;

    if ((b_33556755 < a_33556754)) {
    Temporary1 = makeNimstrLit("index out of bounds, the container is empty");
    }
    else {
    Temporary1 = (makeNimstrLit("index ") || []).concat(HEX24_318767107(i_33556753) || [],makeNimstrLit(" not in ") || [],HEX24_318767107(a_33556754) || [],makeNimstrLit(" .. ") || [],HEX24_318767107(b_33556755) || []);
    }
    
    raiseException({name: "IndexDefect", message: nimCopy(null, Temporary1, NTI33554439), parent: null, m_type: NTI33555128, trace: [], up: null}, "IndexDefect");
...
function fuzzyMatch_603979792(pattern_603979793, str_603979794) {
  ...
  var result_603979797 = {Field0: 0, Field1: false};
    ...
    var colontmp__469762919 = nimMax(0, score_603979804);
    var colontmp__469762920 = (0 < score_603979804);
    result_603979797 = nimCopy(result_603979797, {Field0: colontmp__469762919, Field1: colontmp__469762920}, NTI603979790);
...
function HEX3Aanonymous_469762775(a_469762780, b_469762781) {
  ...
  var result_469762720 = null;
    ...
    db_469762710[0] = nimCopy(null, stuff_469762724.getElementsByClassName("reference"), NTI587203004);
      ...
      Label5: do {
          ...
          if (!(i_469762910 < colontmp__469762909)) break Label6;
            ...
            Label7: do {
              ...
              var colontmp__469762916 = fuzzyMatch_603979792(value_469762719, c_469762768);
