/* Generated by the Nim Compiler v0.1.0-dev.20489 */
var framePtr = null;
var excHandler = 0;
var lastJSError = null;
var NTI603979790 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
var NTI469762603 = {size: 0, kind: 24, base: null, node: null, finalizer: null};
...
function mnewString(len_33556900) {
        return new Array(len_33556900);
...
function nimCopy(dest_33557146, src_33557147, ti_33557148) {
  var result_33557157 = null;
    ...
    case 4:
    case 16:
            if(ArrayBuffer.isView(src_33557147)) { 
        if(dest_33557146 === null || dest_33557146 === undefined || dest_33557146.length != src_33557147.length) {
          dest_33557146 = new src_33557147.constructor(src_33557147);
        } else {
          dest_33557146.set(src_33557147, 0);
        }
        result_33557157 = dest_33557146;
      } else {
...
function nimMax(a_33557005, b_33557006) {
    var Temporary1;

  var result_33557007 = 0;

  BeforeRet: do {
    if ((b_33557006 <= a_33557005)) {
    Temporary1 = a_33557005;
    }
    else {
    Temporary1 = b_33557006;
    }
    
    result_33557007 = Temporary1;
    break BeforeRet;
  } while (false);

  return result_33557007;

}

function nimMin(a_33557001, b_33557002) {
    var Temporary1;

  var result_33557003 = 0;

  BeforeRet: do {
    if ((a_33557001 <= b_33557002)) {
    Temporary1 = a_33557001;
    }
    else {
    Temporary1 = b_33557002;
    }
    
    result_33557003 = Temporary1;
    break BeforeRet;
  } while (false);

  return result_33557003;

}

function addChar(x_33557264, c_33557265) {
    x_33557264.push(c_33557265);
...
function unhandledException(e_33556652) {
    ...
    add_33556408(buf_33556653, 0, e_33556652.name);
...
function HEX3Aanonymous_469762775(a_469762780, b_469762781) {
  ...
  var result_469762720 = null;
    ...
    contents_469762711[0] = nimCopy(null, [], NTI469762603);
    Label1: do {
